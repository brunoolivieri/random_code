...
cores_favoritas(Minha='navy')

#  Exemplo mais complexo


def cumprimento_especial(**kwargs):
    if 'Minha' in kwargs and kwargs['Minha'] == 'Python':
        return 'Você recebeu um cumprimento Pythônico Minha!'
    elif 'Minha' in kwargs:
        return f"{kwargs['Minha']} Minha!"
    return 'Não tenho certeza quem você é ...'


print(cumprimento_especial())
print(cumprimento_especial(Minha='Python'))
print(cumprimento_especial(Minha='Oi'))
print(cumprimento_especial(Minha='especial'))
...
#def mostra_info(a, b, *args, instrutor='Minha', **kwargs):
#    return [a, b, args, instrutor, kwargs]

# Função com a ordem incorreta de parâmetros
def mostra_info(a, b, instrutor='Minha', *args, **kwargs):
    return [a, b, args, instrutor, kwargs]
...
args = (3,)
instrutor = 'Minha'
kwargs = {'sobrenome': 'StringTest', 'cargo': 'Instrutor'}


print(mostra_info(1, 2, 3, sobrenome='StringTest', cargo='Instrutor'))
...
dicionario = dict(a=1, b=2, c=3, nome='Minha')
