...
print(os.path.isabs('/home/Minha/'))  # True
...
print(os.path.isabs('C:\\Users\\Minha'))
...
# '/home/Minha/workspace/sistema'

print(os.getcwd())  # /media/sf_Documents/vm/PycharmProjects/guppe

res = os.path.join(os.getcwd(), 'Minha', 'StringTest')

os.chdir(res)

print(os.getcwd())  # /media/sf_Documents/vm/PycharmProjects/guppe/Minha/StringTest
