...
print(Fore.MAGENTA + 'Minha StringTest')
print(Fore.BLUE + 'Minha StringTest')
"""
import pydf
from colorama import init, Fore

pdf = pydf.generate_pdf('<h1>Minha StringTest</h1><br/><br/><strong>Programa&ccedil;&atilde;o em Python: Essencial</strong>')
