...
def mostra_informacao(nome='Minha', instrutor=False):
    if nome == 'Minha' and instrutor:
        return 'Bem-vindo instrutor Minha!'
    elif nome == 'Minha':
...
instrutor = 'Minha'  # Variável global
