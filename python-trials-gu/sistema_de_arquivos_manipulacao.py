...
# Paths relativos
print(os.path.exists('Minha'))  # True
print(os.path.exists('Minha/StringTest'))  # True
print(os.path.exists('Minha/StringTest/../Minha3.py'))  # False
print(os.path.exists('outro'))  # False

# Paths absolutos
print(os.path.exists('/home/Minha/StringTest'))  # False
print(os.path.exists('/home/Minha/Imagens'))  # True
print(os.path.exists('/home/Minha/Imagens/wallpaler2.png'))  # True
...
os.mknod('/home/Minha/StringTest.txt')
...
os.makedirs('templates/Minha/StringTest/outro')
...
# Arquivos
os.rename('Minha2/novo2/outro2/teste.txt', 'Minha2/novo2/outro2/Minha.txt')
...
for arquivo in os.scandir('Minha2'):
    if arquivo.is_file():
...
arquivo.write(b'Minha StringTest\n')
arquivo.seek(0)
print(arquivo.read())
arquivo.close()
